...
<c:if test="${mVO.authority eq 'ROLE_ARTIST'}">
		...
		<section id="my_artwork_order" class="active">
			<section id="my_account_body" class="orders">
				<div class="orders_view in_progress">
					...
					<h3>1:1 문의하기</h3>
					<div class="inputbox">
						<form:form id="formbox" method="post" action="inquiryWriteAction.do"
							class="login_required"  onsubmit="return nullCheck(this);">
							...
							<div class="fieldset">
								<div class="form-row cf">
									...
									<div class="form-right">
										...
										<input type="hidden" name="bname" value="inquiry" /> <span><sec:authentication
		...
		<button type="submit" id="submit" class="inquiry-Button" >확인</button>
		</form:form>
	</div>
</body>
