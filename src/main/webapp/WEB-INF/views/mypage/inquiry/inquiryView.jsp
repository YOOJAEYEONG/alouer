...
<c:if test="${mVO.authority eq 'ROLE_ARTIST'}">
		                ...
		                <h3>1:1 문의 내역</h3>
		                  <div >
		                      <table class="order_list">
		                          <tbody>
		                             <tr>
		                                  <th scope="col" class="date_order" style="width: 10%;">글번호 : ${list.idx}</th>
			                              <th scope="col" class="date_install" style="width: 65%;">제목 : ${list.title}</th>
          ...
          <button class="inquiry-Button" onclick="location.href='inquiryWrite.do'">새로운 문의하기</button>
          <button class="inquiry-Button" onclick="location.href='inquiryEdit.do?idx=${list.idx}'">수정하기</button>
