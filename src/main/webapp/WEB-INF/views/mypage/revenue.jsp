...
<body>
	<div id="contents" data-login_required="true">
        ...
        <nav id="myAccountNav" class="cf">
            ...
            <a href="${pageContext.request.contextPath}/mypage/revenue" class="myAccountNav-btn current" >나의 수익</a>
                    ...
                    <div>
                        <table class="order_list">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="type">작품이미지</th>
                                <th scope="col" class="artworks">작품명/작가명</th>
                                <th scope="col" class="date_install">나의 지분</th>
                                <th scope="col" class="date_return">수익률</th>
                                <th scope="col" class="status">수익금</th>
                            </tr>
                            <c:forEach items="${revenueInfo }" var="revenue">
	                        	
                        	<c:choose>
                        	<c:when test="${empty revenueInfo }">
                                <tr>
                        	...
                        	<c:otherwise>
                        		<tr>
	                                <td class="empty">${revenue.virtualNum }</td>
	                                <td class="empty"><a href="${pageContext.request.contextPath}/rental/view.do?code=${revenue.code}">
	                                	<img src="${revenue.imageUrl }" style="max-width: 100px; max-height: 100px;"/></a></td>
	                                <td class="empty">${revenue.title }<br>${revenue.name }</td>
	                                <td class="empty">${revenue.stockCnt }</td>
	                                <td class="rentalPrice" style="text-align:left;"><fmt:formatNumber value="${revenue.myProfitPercent }"/>%
	                                				</td>
	                                <td class="rentalPrice" style="text-align:left;"><fmt:formatNumber value="${revenue.myProfitMoney }"/>원
	                                				</td>
	                            </tr>
                        	</c:otherwise>
                        	</c:choose>
